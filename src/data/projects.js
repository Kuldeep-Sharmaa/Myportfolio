...
export const projects = [
  ...
  {
    title: "E-Wallet Company Website",
    type: "FinTech Design",
    role: "Frontend Development & UI Design",
    description:
      "Built a structured dashboard interface focused on clarity and predictable user flow, making financial information easier to scan and understand in a trust-sensitive product.",
    tech: ["HTML", "CSS", "JavaScript", "Responsive Design"],
    link: "https://kuldeep-sharmaa.github.io/E-wallet-Website",
  },
];
